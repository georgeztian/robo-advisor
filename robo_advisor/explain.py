...
REPORT_DISCLAIMER = (
    "This robo-advisor provides automated, data-driven outputs for informational purposes only and "
    "does not constitute financial, investment, legal, or trading advice. All model insights are "
    "generated by algorithms based on historical data, which is not a guarantee of future performance "
    "or returns. Do not rely on this system as your sole source for making investment decisions. "
